          ...
          {data.map(({ value, desc }) => (
            <TabPanel key={value} value={value}>
              <div className="flex gap-16">
                ...
                <div>
                  <Paragraph className="text-[#1D293F] mb-5" text={desc} />
                  ...
                  <div className="flex flex-wrap gap-y-7 mt-14">
                    {info.map(({title,logo,besideLogo}) => (
                      <div key={title} className="basis-1/3">
                        <Subheading text={title} className='text-base text-[#546179]'/>
                        <div className="flex items-center gap-2 mt-7">
                          <Image src={logo}/>
                          <Subheading text={besideLogo} className='text-[#1D293F] font-medium'/>
