  ...
  return (
    <div className={`w-[1328px] h-[176px] px-[71px] bg-white rounded-2xl flex items-center ${className}`}>
        ...
        <div className="ps-14">
            ...
            <form className="flex items-center gap-10">
              <select name="Location"  className="py-2 bg-white font-poppins font-normal text-[18px] text-[#99A3AD]  " id="Location">
                <option selected >Set date</option>
                <option value='sky diving' >Sky diving</option>
                <option value='horse riding' >Horse riding</option>
              </select>
              <Date className='text-3xl text-black/70 me-10'/>
            </form>
        </div>
    </div>
  )
